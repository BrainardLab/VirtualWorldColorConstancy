...
correctClassificationTrain = sum(estimatedTrainLabel == trainingLabels')/length(trainingLabels);
correctClassificationTest = sum(estimatedTestLabel == testLabels')/length(testLabels);
