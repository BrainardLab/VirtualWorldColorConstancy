% Condition4.m
% This script renders 1000 images for condition 4.
%
% This condition is not mentioned in the paper. The condition is similar to
% Condition 3, but we have switched off the option for secondary
% reflections.
%
% Condition:
...
RunToyVirtualWorldRecipes('outputName','Condition3', ...
    ...
    'maxDepth', 2);    % maxDepth = 2 + Number of secondary reflections.
