% Make Figure 5b in the paper
% 
% This script is similar to Condition2.m
...
% same shape as in figure 5b. This is done through the option
% targetReflectanceScaledCopies.
%
% Finally the cropped image montage is made through the funciton
% makeCroppedImageMontage
%
% The cropped image montage will be saved in the folder Figure5b.
%
%

RunToyVirtualWorldRecipes('outputName','Figure5b', ...
    ...
    makeCroppedImageMontage('Figure5b',[0.2 0.4 0.6], [1:5],0.005);