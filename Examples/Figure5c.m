% Make Figure 5c in the paper
% 
% This script is similar to Condition3.m
...
% same shape as in figure 5c. This is done through the option
% targetReflectanceScaledCopies.
%
% Finally the cropped image montage is made through the funciton
% makeCroppedImageMontage
%
% The cropped image montage will be saved in the folder Figure5c.
%
%

RunToyVirtualWorldRecipes('outputName','Figure5c', ...
    ...
    'otherObjectReflectanceRandom', true, ... % Background reflectance spectra, false -> fixed
    ...
    makeCroppedImageMontage('Figure5c',[0.2 0.4 0.6], [1:5],0.005);