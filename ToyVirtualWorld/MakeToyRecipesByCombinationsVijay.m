function MakeToyRecipesByCombinationsVijay(varargin)
...
parfor sceneIndex = 1:nScenes
    ...
    for attempt = 1:maxAttempts
        ...
        if workingRecord.rejected
            ...
            % Put back the mask style in the workingRecord structure just
            % for the sake of it. This seems totally unnecessary right now
            workingRecord.styles.mask = {quickRendering, allBlackDiffuse, firstShapeEmitter};
