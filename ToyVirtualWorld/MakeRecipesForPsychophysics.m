function MakeRecipesForPsychophysics(varargin)
...
for bb = 1:nBaseScenes
    ...
    [baseScenes{bb}, baseSceneInfos{bb}] = VseModel.fromAsset('BaseScenes', name, ...
        'aioPrefs', aioPrefs, ...
        'nameFilter', 'blend$');
    baseScenes{bb}.model.cameras.horizontalFov = baseScenes{bb}.model.cameras.horizontalFov/4;
    baseScenes{bb}.model.cameras.aspectRatio = 2;
end
