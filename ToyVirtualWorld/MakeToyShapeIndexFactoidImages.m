...
if ~isempty(targetMask)
    ...
    recipe.processing.target.cropLocationC=cropLocationC;
    recipe.processing.target.cropLocationR=cropLocationR;
...
recipe = SaveRecipeProcessingImageFile(recipe, group, 'croppedImage', 'mat', croppedImage);
